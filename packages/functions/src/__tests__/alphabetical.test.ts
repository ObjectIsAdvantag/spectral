...
describe('Core Functions / Alphabetical', () => {
  it.concurrent('given falsy target, should return no error message', async () => {
    expect(await runAlphabetical(false)).toEqual([]);
  });

  it.concurrent('given single element target, should return no error message', async () => {
    expect(await runAlphabetical(['a'])).toEqual([]);
  });

  it.concurrent('given an object and keys not in order, should return an error message', async () => {
    expect(
  ...
  it.concurrent(
    'given an object with unsorted properties with numeric keys, should return an error message',
    async () => {
...
'200':
  ...
  describe('given NO keyedBy', () => {
    it.concurrent('given an unsorted array of strings should return an error message', async () => {
    ...
    it.concurrent('given a sorted array of strings, should return no error message ', async () => {
      expect(await runAlphabetical(['a', 'ab'])).toEqual([]);
    });

    it.concurrent('given an unsorted array of numbers, should return an error message ', async () => {
    ...
    it.concurrent('given an array of objects should return an error', async () => {
    ...
    it.concurrent('given an array containing invalid values should return an error', async () => {
  ...
  describe('given keyedBy', () => {
    it.concurrent('given an array of objects with unsorted prop values should not return an error', async () => {
    ...
    it.concurrent('given an array of objects with sorted prop values should not return an error', async () => {
      expect(await runAlphabetical([{ a: '1' }, { a: '2' }, { a: '2' }], { keyedBy: 'a' })).toEqual([]);
    });

    it.concurrent('given an array of primitives, should return an error message ', async () => {
  ...
  it.concurrent('is able to trap object again', async () => {
  ...
  describe('validation', () => {
    it.concurrent.each([null, {}, { keyedBy: 'bar' }])('given valid %p options, should not throw', async opts => {
